...
VALUES 
    (N'Galaxy S21', 1, 799.99, 50, N'Samsung flagship model'),
    (N'iPhone 13', 2, 999.99, 30, N'Apple flagship model'),
    (N'Redmi Note 10', 3, 199.99, 100, N'Budget phone from Xiaomi');
GO
...
VALUES 
    (N'0123456789', N'Alice', GETDATE(), 2999.97, N'First purchase'),
    (N'0987654321', N'Bob', GETDATE(), 3999.96, N'Returning customer');
GO
